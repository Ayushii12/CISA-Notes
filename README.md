...
- **Audit Phases**:
  ...
  |                     | **Determine the audit scope** | The scope may be restricted to a few applications or few processes only. <br> Defining the scope will help the auditor determine the resources required for conducting the audit. |
...
- Sampling is the process of **selecting data from a population**
